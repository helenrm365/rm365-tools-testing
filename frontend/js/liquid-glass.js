...
(function() {
    ...
    function enableLiquidGlass() {
        ...
        if (!document.getElementById('liquid-glass-styles')) {
            ...
            homeLink.href = `/css/liquid-glass/home.css?v=${timestamp}`;
            ...
            inventoryLink.href = `/css/liquid-glass/inventory.css?v=${timestamp}`;
            ...
            labelsLink.href = `/css/liquid-glass/labels.css?v=${timestamp}`;
            ...
            magentoLink.href = `/css/liquid-glass/magentodata.css?v=${timestamp}`;
            ...
            ordersLink.href = `/css/liquid-glass/orders.css?v=${timestamp}`;
            ...
            usersLink.href = `/css/liquid-glass/usermanagement.css?v=${timestamp}`;
            ...
            loginLink.href = `/css/liquid-glass/login.css?v=${timestamp}`;
