...
import { getFRMagentoData, getFRAggregatedData, refreshAggregatedDataForRegion, checkTablesStatus, initializeTables, syncFRMagentoData } from '../../services/api/magentoDataApi.js?v=7';
...
async function loadMagentoData() {
  ...
  try {
    ...
    if (viewMode === 'aggregated') {
      ...
      result = await getFRMagentoData(pageSize, offset, '', currentSortColumn || '', currentSortDirection);
    }
