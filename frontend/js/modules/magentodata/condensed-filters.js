// frontend/js/modules/magentodata/condensed-filters.js
import { get, post, del } from '../../services/api/http.js';
import { showToast } from '../../ui/toast.js';
import { refreshCondensedDataForRegion } from '../../services/api/magentoDataApi.js';
    ...
    overlay.innerHTML = `
        <div class="filters-modal" onclick="event.stopPropagation()">
            <div class="filters-modal-header">
                <h2><i class="fas fa-chart-bar"></i> 6M Condensed Magento Filters - ${region.toUpperCase()}</h2>
            ...
            <div class="filters-modal-body">
                ...
                <div class="filter-section">
                    ...
                    <p class="filter-section-description">
                        Orders from these customers will not be included in the 6-month condensed magento data.
                    </p>
                ...
                <div class="filter-section">
                    ...
                    <p class="filter-section-description">
                        Orders from these customer groups will not be included in the 6-month condensed magento data.
                    </p>
                ...
                <div class="filter-section">
                    ...
                    <p class="filter-section-description">
                        Orders with a grand total above this amount will be excluded from 6-month condensed magento.
                ...
                <div class="filter-section">
                    ...
                    <p class="filter-section-description">
                        Orders with a quantity above this amount will be excluded from 6-month condensed magento.
                    </p>
...
async function applyAllFilters(region) {
    ...
    // Show custom confirmation dialog
    const confirmMessage = 'Apply all filter changes and refresh 6M condensed magento data?';
...
window.runCustomAnalysis = async function(region) {
    ...
    try {
        ...
        const { getCustomRangeCondensedData } = await import('../../services/api/magentoDataApi.js');
