  ...
  try {
    ...
    $('#historyTable').innerHTML = `
      <div class="error-state">
        ...
        <button class="btn btn-solid btn-success" onclick="location.reload()">
          ...
          <tr class="${selectedJobIds.has(job.id) ? 'selected' : ''}">
            ...
            <td class="col-actions">
              <div class="action-buttons">
                <button class="btn btn-flat btn-primary btn-sm" data-action="view" data-job-id="${job.id}" title="View Details">
                ...
                <button class="btn btn-flat btn-danger btn-sm btn-icon-only" data-action="delete" data-job-id="${job.id}" title="Delete Job">
