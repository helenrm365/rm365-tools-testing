// frontend/js/modules/france-orders/scanning-logs.js
// France Orders - Scanning Logs Module
...
const BRANCH_CONFIG = {
  branchId: 'fr-paris',
  branchName: 'France Paris',
  apiPrefix: '/v1/inventory/scanning-logs/fr-paris'
};
...
export function init() {
  console.log('[ScanningLogs] Initializing France Scanning Logs module');
  scanningLogsManager = new ScanningLogsManager();
}

export function cleanup() {
  console.log('[ScanningLogs] Cleaning up France Scanning Logs module');
