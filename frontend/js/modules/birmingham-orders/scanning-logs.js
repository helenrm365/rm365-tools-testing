// frontend/js/modules/birmingham-orders/scanning-logs.js
// Birmingham Orders - Scanning Logs Module
...
const BRANCH_CONFIG = {
  ...
  apiPrefix: '/v1/inventory/scanning-logs/uk-birmingham'
};
...
export function init() {
  console.log('[ScanningLogs] Initializing Birmingham Scanning Logs module');
  scanningLogsManager = new ScanningLogsManager();
}

export function cleanup() {
  console.log('[ScanningLogs] Cleaning up Birmingham Scanning Logs module');
