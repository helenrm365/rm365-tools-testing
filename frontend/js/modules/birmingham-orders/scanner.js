// frontend/js/modules/birmingham-orders/scanner.js
// Birmingham Orders - Inventory Scanner Module
...
const BRANCH_CONFIG = {
  branchId: 'uk-birmingham',
  branchName: 'UK Birmingham',
  apiPrefix: '/v1/inventory/management/uk-birmingham',
  adjustmentsApiPrefix: '/v1/inventory/adjustments',
  scanningLogsApiPrefix: '/v1/inventory/scanning-logs/uk-birmingham'
};
...
class InventoryScannerManager {
  ...
  setupMobileLayout() {
    ...
    // Use ResizeObserver for dynamic updates (font size changes, orientation)
...
export async function init(path) {
  console.log('[Birmingham Scanner] Initializing...');
  ...
  try {
    ...
    if (statusResult.status === 'success' && !statusResult.all_tables_exist) {
      ...
      console.log('[Birmingham Scanner] Some tables missing, initializing...', statusResult.tables_status);
      await initializeTables(BRANCH_CONFIG.branchId);
      console.log('[Birmingham Scanner] Tables initialized successfully');
    }
  } catch (error) {
    console.error('[Birmingham Scanner] Error checking/initializing tables:', error);
  ...
  console.log('[Birmingham Scanner] Initialized');
}

export async function cleanup() {
  console.log('[Birmingham Scanner] Cleaning up...');
